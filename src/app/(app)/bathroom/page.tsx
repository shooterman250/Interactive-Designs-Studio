...
const PAGE_STAGE_KEY: DesignStageKey = "bathroom";
const newConsoleImageUrl = "/Bathroom_ Sink_ Console.png";
...
export default function BathroomPage() {
  ...
  const pageSpecificDisplayBathroomStyleOptions: BaseSelectionItem[] = baseBathroomStyleOptions.map(style => {
    ...
    if (style.id === 'biophilic') imageUrl = '/Bathroom Style_ Biophilic.png';
    else if (style.id === 'bohemian') imageUrl = '/Bathroom Style_ Bohemian.png';
    else if (style.id === 'coastal') imageUrl = '/Bathroom Style_ Coastal.png';
    else if (style.id === 'contemporary') imageUrl = '/Bathroom Style_ Contemporary.png';
    else if (style.id === 'country-farmhouse') imageUrl = '/Bathroom Style_ Country_Farmhouse.png';
    else if (style.id === 'industrial') imageUrl = '/Bathroom Style_ Industrial.png';
    else if (style.id === 'japandi') imageUrl = '/Bathroom Style_ Japandi.png';
    else if (style.id === 'mid-century') imageUrl = '/Bathroom Style_ Mid-Century.png';
    else if (style.id === 'modern') imageUrl = '/Bathroom Style_ Modern.png';
    else if (style.id === 'traditional') imageUrl = '/Bathroom Style_ Traditional.png';
    return {
      ...style,
      name: name,
      imageUrl: imageUrl,
  ...
  const pageSpecificDisplayBathroomHalfSinkOptions: BaseSelectionItem[] = baseBathroomHalfSinkOptions.map(sink => {
    ...
    if (sink.id === 'bh-sink-vessel') {
      imageUrl = "/Bathroom_ Sink_ Vessel.png";
    }
    if (sink.id === 'bh-sink-wallmount') {
      imageUrl = "/Bathroom_ Sink_ Wall-Mounted.PNG";
    }
    return {
      ...sink,
      name: `${originalNamePart}\nBathroom Sink`,
