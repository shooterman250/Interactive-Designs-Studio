...
export default function KitchenPage() {
  ...
  const pageSpecificKitchenStyleOptions: BaseSelectionItem[] = baseOverallStyleOptions.map(style => {
    ...
    // Map to local Kitchen-specific style images
    if (style.id === 'biophilic') imageUrl = '/Kitchen_ Style_ Biophilic .png';
    else if (style.id === 'bohemian') imageUrl = '/Kitchen_ Style_ Bohemian.png';
    else if (style.id === 'coastal') imageUrl = '/Kitchen_ Style_ Coastal.png';
    else if (style.id === 'contemporary') imageUrl = '/Kitchen_ Style_ Contemporary.png';
    else if (style.id === 'country-farmhouse') imageUrl = '/Kitchen_ Style_ Country_Farmhouse.png';
    else if (style.id === 'industrial') imageUrl = '/Kitchen_ Style_ Industrial.png';
    else if (style.id === 'japandi') imageUrl = '/Kitchen_ Style_ Japandi.png';
    else if (style.id === 'mid-century') imageUrl = '/Kitchen_ Style_ Mid-Century.png';
    else if (style.id === 'modern') imageUrl = '/Kitchen_ Style_ Modern.png';
    else if (style.id === 'traditional') imageUrl = '/Kitchen_ Style_ Traditional.png';
